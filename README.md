...
| 5 – Temporal      | `src/temporal.py` | Majority vote confirmation across multiple frames       |
| 6 – Full pipeline | `src/main.py`     | All stages + CSV logging                                |
...
│   ├── temporal.py     ← Step 5: temporal confirmation
│   └── main.py         ← Step 6: full live pipeline
├── data/
